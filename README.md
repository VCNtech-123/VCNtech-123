...
<p align="center">
  IT Student • Frontend Developer • Building clean and responsive web experiences
</p>
...
I'm an IT student with a strong interest in frontend development and UI design.  
I enjoy building websites that are clean, responsive, and easy to use.

Right now, I’m focused on improving my skills in **React**, **JavaScript**, and modern web development tools while working toward becoming a **full-stack MERN developer**.

- Currently building: **Portfolio v2.0**
- Currently learning: **Advanced React, TypeScript, and MongoDB**
- Interested in: **Frontend development, UI design, and web apps**
- Ask me about: **CSS layouts, JavaScript logic, and movie APIs**
